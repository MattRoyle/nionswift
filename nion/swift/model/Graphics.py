...
class GraphicRenderer:
    ...
    @classmethod
    def is_label_visible(cls, label_visibility: str, is_selected: bool, is_focused: bool) -> bool:
        if label_visibility == "always":
            return True
        elif label_visibility == "selection":
            return is_selected
        elif label_visibility == "focus":
            return is_focused
        return False
